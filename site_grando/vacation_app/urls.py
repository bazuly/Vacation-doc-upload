...
from .views import vacation_upload, vacation_upload_success, list_vac, vacation_edit_success, edit_vacation_status
...
urlpatterns = [
    ...
    path('edit_vacation_status/<int:vacation_id>/', edit_vacation_status, name='edit_vacation_status')
]